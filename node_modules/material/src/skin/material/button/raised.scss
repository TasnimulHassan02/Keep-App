...
.button.type-raised {
  ...
  &:active {
    box-shadow:
      0px 4px 4px -3px rgba(0, 0, 0, 0.2),
...
// theme
.dark-mode .button.type-raised,
.button.type-raised.dark-mode {
  .material-ripple {
    opacity: 0.1;
  ...
  &.secondary-color {
    ...
    color: $secondary-color-text-dark;
    .button-icon {
      svg {
        fill: $secondary-color-text-dark;
      }
    }
    &:focus {
      background-color: color.adjust($secondary-color, $lightness: 10%);
